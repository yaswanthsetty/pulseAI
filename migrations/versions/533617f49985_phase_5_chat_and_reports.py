...
down_revision: str | Sequence[str] | None = "6928a7f1c674"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "evidence_agreement", sa.dialects.postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        "ix_reports_user", "reports", ["user_id", sa.text("created_at DESC")], unique=False
    )
